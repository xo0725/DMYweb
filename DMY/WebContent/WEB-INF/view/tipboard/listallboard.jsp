...
%>
		   ...
		   <div class="board_content" data-no ="<%= param.getdtb_no() %>">
				...
				<div class="content content_pw" style="width: 6%;"><%= param.getdtb_pw() %></div>
				<div class="content content_view" style="width: 6%;"><%= param.getdtb_viewcnt() %></div>
				<div class="content content_good" style="width: 6%;"><%= param.getdtb_goodcnt() %></div>
				<div class="content content_shareYN" style="width: 5%;"><%= param.getdtb_shareyn() %></div>
				<div class="content content_deleteYN" style="width: 5%;"><%= param.getdtb_deleteyn() %></div>
				<div class="content content_inserdate" style="width: 12%;"><%= param.getdtb_insertdate() %></div>
				<div class="content content_updatedate" style="width: 12%;"><%= param.getdtb_updatedate() %></div>
